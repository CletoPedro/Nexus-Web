...
class InventoryService:
    ...
    async def _validate_document_reference(self, document_id: uuid.UUID | None) -> None:
    ...
    async def create_item(
        ...
        *,
        ...
        await self._validate_document_reference(document_id)
        item = InventoryItem(
            name=name.strip(),
    ...
    async def search_items(self, query: str, *, limit: int = 50) -> list[InventoryItem]:
